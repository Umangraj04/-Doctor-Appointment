...
const Tabs = ({tab,setTab}) => {
  ...
  return (
    ...
    <div>
       ...
       <div className='hidden lg:flex flex-col p-[30px] bg-gray-400 shadow-panelShadow items-center h-max rounded-md'>
       ...
       <button onClick={()=> setTab('appointments')}  className={`${tab=="appointments" ? "bg-indigo-100 text-primaryColor" : "bg-transparent text-headingColor"}w-full btn mt-0 rounded-md`}>Appointment</button>
