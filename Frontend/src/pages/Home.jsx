    ...
    {/*=========   hero section =========== */}
      ...
      <section className='hero__section pt-[60px] 2xl:h-[800px]'>
        <div className='container'>
          ...
          Providing personalized, expert healthcare tailored to you and your family
          </p>
          ...
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            ...
            <div>
              ...
              <p className='text__para'>patient Satisfaction
      ...
      <section>
       ...
       <section>
        <div className='flex items-center justify-between flex-col lg:flex-row'>
           ...
           <li className='text__para'>
           3. View our physicians and who are accepting new patient, use the 
           ...
           <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            ...
            <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'></div>
